...
<template>
  <div :class="[ prefixCls, 'bg-[var(--el-color-white)] dark:bg-[var(--el-bg-color)] dark:border-[var(--el-border-color)] dark:border-1px' ]" >
    ...
    <ElCollapseTransition>
      <div v-show="show" :class="[`${prefixCls}-content`, 'p-20px']">
        <ElRow
          gutter={0}
          {...unref(getBindValue)}
        ...
        >
          <template v-for="item in schema" :key="item.field">
            ...
            >
              <div v-if="direction === 'horizontal'" class="flex items-stretch bg-[var(--el-fill-color-light)] outline-1px outline-[var(--el-border-color-lighter)] outline-solid flex-1">
                <div
              ...
              <div v-else class="bg-[var(--el-fill-color-light)] outline-1px outline-[var(--el-border-color-lighter)] outline-solid flex-1">
                <div
